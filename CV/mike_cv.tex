...
\item \textbf{Machine Learning:} Python, scikit-learn, PyTorch, design of deep learning models, training and evaluation.
\item \textbf{Data analysis and mining:} Python, Pandas, Matlab, data preprocessing and visualization, time series analysis.
\item \textbf{Infrastructure:} Docker, SLURM.
\end{itemize}
...
\begin{itemize}[leftmargin=*,noitemsep]
    ...
    \item Designed an interpretable DL model of brain activation dynamics for mining brain connectivity patterns and markers of brain disorders.
