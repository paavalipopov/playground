...
%---------------------------------------------------------
  \cventry
    {Benchmark a dozen DL models for fMRI analysis on any data} % Affiliation/role
    {ml4fmri} % Organization/group
    {} % Location
    {} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        \item {\hyperlink{https://pypi.org/project/ml4fmri/}{PyPI page}}
        \item {\hyperlink{https://github.com/neuroneural/meanMLP/tree/ml4fmri}{Github repo}}
      \end{cvitems}
    }
  ...
  \cventry
    {Tool for quick visualization of neuroimaging data} % Affiliation/role
    {brainbow} % Organization/group
    {} % Location
    {} % Date(s)
    {
      \begin{cvitems} % Description(s) of experience/contributions/knowledge
        \item {\hyperlink{https://pypi.org/project/brainbow/}{PyPI page}}
        \item {\hyperlink{https://github.com/neuroneural/brainbow}{Github repo}}
      \end{cvitems}
    }
