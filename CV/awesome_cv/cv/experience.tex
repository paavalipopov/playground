...
\begin{cventries}
  \cventry
    ...
    {Center for Translational Research in Neuroimaging and Data Science} % Organization
    {Atlanta, USA} % Location
    {2022 - Now} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		\item {Designed interpretable deep learning models for medical diagnostics and neuroimaging data analysis.}
		\item {Searched for markers and mechanisms of brain disorders present in the neuroimaging data}
      \end{cvitems}
    }
  \cventry
    {Research assistant} % Job title
    {Institute of Radioengineering and Electronics} % Organization
    {Moscow, Russia} % Location
    {2017 - 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		\item {Investigated magnetization phenomena in magnetic crystals, studied their potential for new logic devices.}
      \end{cvitems}
    }
\end{cventries}
